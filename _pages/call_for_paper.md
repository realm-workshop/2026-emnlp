...
**REALM'26** invites authors to submit 4-page or 8-page (short/long) papers about their work at the intersection of AI Agents and LLMs.
...
All submissions must follow the **[ACL 2026 style guidelines](https://acl-org.github.io/ACLPUB/formatting.html)**. The **[ACL 2026 style files](https://github.com/acl-org/acl-style-files)** must be used; these are provided in LaTeX and also Microsoft Word format. Submissions will only be accepted in PDF format.
